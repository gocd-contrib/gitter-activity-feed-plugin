...
import cd.go.contrib.activityfeed.gitter.executors.GetPluginConfigurationExecutor;
import cd.go.contrib.activityfeed.gitter.executors.GetViewRequestExecutor;
import cd.go.contrib.activityfeed.gitter.executors.NotificationInterestedInExecutor;
...
import static cd.go.contrib.activityfeed.gitter.Constants.PLUGIN_IDENTIFIER;

@Extension
public class GitterNotificationFeedPlugin implements GoPlugin {

    public static final Logger LOG = Logger.getLoggerFor(GitterNotificationFeedPlugin.class);
